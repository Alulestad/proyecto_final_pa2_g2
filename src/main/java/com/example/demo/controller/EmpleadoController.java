...
import com.example.demo.repo.service.IBodegueroSer;
...
public class EmpleadoController {
	...
	@Autowired
	private IBodegueroSer bodegueroSer;
...
////////////////////////////////////////////VEHICULOSVIP//////////
	...
	///////////////BODEGUERO
	@GetMapping("nuevoBodeguero")
	public String nuevoBodeguero(Bodeguero bodeguero) {
		return "Empleado/insertarBodeguero";
		
		
	}
	@PostMapping("insertarBodeguero")
	public String insertaBodeguero(Bodeguero bodeguero) {
		this.bodegueroSer.insertarBodeguero(bodeguero);
		System.out.println("Insertado!");
		return "Principal/vistaMenuPrincipal";
